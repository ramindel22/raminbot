...
if matches[1] == "pin" and is_mod(msg) or matches[1] == "پین" and is_mod(msg) and msg.reply_id then
...
if matches[1] == 'unpin' and is_mod(msg) or matches[1] == 'لغو' and is_mod(msg) then
local lock_pin = data[tostring(msg.to.id)]["settings"]["lock_pin"] 
 if lock_pin == 'yes' then
if is_owner(msg) then
...
if matches[1] == "add" or matches[1] == "ادد" then
return modadd(msg)
end
if matches[1] == "rem" or matches[1] == "ریم" then
return modrem(msg)
end
if matches[1] == "setowner" and is_admin(msg) or matches[1] == "ست اونر" and is_admin(msg) then
...
if matches[1] == "remowner" and is_admin(msg) or matches[1] == "ریم اونر" and is_admin(msg) then
if not matches[2] and msg.reply_id then
    tdcli_function ({
      ID = "GetMessage",
      chat_id_ = msg.to.id,
...
if matches[1] == "promote" and is_owner(msg) or matches[1] == "مدیر" and is_owner(msg) then
if not matches[2] and msg.reply_id then
    tdcli_function ({
      ID = "GetMessage",
      chat_id_ = msg.to.id,
...
if matches[1] == "demote" and is_owner(msg) or matches[1] == "برداشتن" and is_owner(msg) then
if not matches[2] and msg.reply_id then
 tdcli_function ({
      ID = "GetMessage",
      chat_id_ = msg.to.id,
...
if matches[2] == "mention" or matches[2] == "هایپر" then
...
if matches[2] == "markdown" or matches[2] == "بولد" then
...
if matches[2] == "markdown" or matches[2] == "بلود" then
...
if matches[1] == "mute" and is_mod(msg) or matches[1] == "بی صداکردن" and is_mod(msg) then
local target = msg.to.id
...
if matches[2] == "contact" or matches[2] == "کانتکت" then
...
if matches[2] == "game" or matches[2] == "ارسال بازی" then
...
if matches[1] == "unmute" and is_mod(msg) or matches[1] == "فعال کردن" and is_mod(msg) then
local target = msg.to.id
if matches[2] == "all" or matches[2] == "همه" then
